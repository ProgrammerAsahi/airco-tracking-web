(() => {
  ...
  const translations = {
    en: {
      ...
      s5Title: "5. Processors",
      s5Body: "We use Microsoft Azure, including Azure Communication Services for email, hosted in the EU region, and Stripe for payment processing. These providers process data on our behalf under data processing agreements.",
      s6Title: "6. Retention",
      s6Body: "Alert outbox rows are deleted after 30 days and terminal email delivery rows after 90 days. Account data is kept until you ask us to delete your account; deletion requests are honoured without undue delay.",
      s7Title: "7. Your rights",
      s7Body: "You have the right to access, rectify, or erase your data, to restrict or object to processing, and to data portability. You also have the right to lodge a complaint with the Dutch supervisory authority, the Autoriteit Persoonsgegevens.",
      s8Title: "8. Contact",
    ...
    fr: {
      ...
      s5Title: "5. Sous-traitants",
      s5Body: "Nous utilisons Microsoft Azure, y compris Azure Communication Services pour l’e-mail, hébergé dans la région UE, et Stripe pour le traitement des paiements. Ces prestataires traitent les données pour notre compte dans le cadre d’accords de traitement des données.",
      s6Title: "6. Durées de conservation",
      s6Body: "Les lignes de la boîte d’envoi d’alertes sont supprimées après 30 jours et les lignes de livraison d’e-mails terminées après 90 jours. Les données du compte sont conservées jusqu’à ce que vous demandiez la suppression de votre compte ; les demandes de suppression sont traitées sans retard injustifié.",
      s7Title: "7. Vos droits",
      s7Body: "Vous disposez d’un droit d’accès, de rectification ou d’effacement de vos données, de limitation ou d’opposition au traitement, ainsi qu’à la portabilité des données. Vous avez également le droit d’introduire une réclamation auprès de l’autorité de contrôle néerlandaise, l’Autoriteit Persoonsgegevens.",
      s8Title: "8. Contact",
    ...
    nl: {
      ...
      s2Body: "Airco Tracker verwerkt alleen de gegevens die nodig zijn om de dienst te leveren: je e-mailadres (account en inlogcodes), je bijnaam, je taal- en bezorglandvoorkeuren en — als je een pas koopt — het merk en de laatste vier cijfers van je betaalkaart plus je Stripe-klantnummer. We gebruiken geen analytische of trackingcookies. De enige cookie is de strikt noodzakelijke sessiecookie waarmee je ingelogd blijft; je taalkeuze wordt in de localStorage van je browser bewaard.",
      ...
      s5Title: "5. Verwerkers",
      s5Body: "We gebruiken Microsoft Azure, inclusief Azure Communication Services voor e-mail, gehost in de EU-regio, en Stripe voor betalingsverwerking. Deze partijen verwerken gegevens in onze opdracht op basis van verwerkersovereenkomsten.",
      s6Title: "6. Bewaartermijnen",
      s6Body: "Rijen in de meldings-outbox worden na 30 dagen verwijderd en definitieve e-mailafleveringsrijen na 90 dagen. Accountgegevens worden bewaard totdat je ons vraagt je account te verwijderen; verwijderingsverzoeken worden zonder onredelijke vertraging ingewilligd.",
      s7Title: "7. Je rechten",
      s7Body: "Je hebt recht op inzage, rectificatie of verwijdering van je gegevens, op beperking van en bezwaar tegen de verwerking, en op gegevensoverdraagbaarheid. Je hebt ook het recht een klacht in te dienen bij de Autoriteit Persoonsgegevens.",
      s8Title: "8. Contact",
    ...
    zh: {
      ...
      s2Title: "2. 我们处理的数据",
      s2Body: "Airco Tracker 仅处理运行服务所必需的数据:您的邮箱地址(用于账号和登录验证码)、昵称、语言与配送国家偏好;购买通行证时还会保存支付卡品牌与后四位以及 Stripe 客户 ID。我们不使用任何分析或跟踪 Cookie——唯一的 Cookie 是维持登录状态所必需的会话 Cookie;您的语言选择保存在浏览器 localStorage 中。",
      s3Title: "3. 处理目的",
      ...
      s5Title: "5. 数据处理者",
      s5Body: "我们使用托管于欧盟区域的 Microsoft Azure(包括用于发送邮件的 Azure Communication Services),以及用于支付处理的 Stripe。这些服务商依据数据处理协议代表我们处理数据。",
      s6Title: "6. 保存期限",
      s6Body: "提醒发件箱记录在 30 天后删除,终态邮件投递记录在 90 天后删除。账号数据保存至您请求删除账号为止;我们会在无不当延迟的情况下处理删除请求。",
      s7Title: "7. 您的权利",
      s7Body: "您有权访问、更正或删除您的数据,限制或反对处理,以及要求数据可携带。您还有权向荷兰监管机构 Autoriteit Persoonsgegevens(个人数据管理局)投诉。",
      s8Title: "8. 联系方式",
