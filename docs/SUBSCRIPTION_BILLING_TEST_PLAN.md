...
| ⬜ | `/subscribe?lang=zh/en` | 中英双语页面可加载，按钮行为一致 | 待测 |
| ⬜ | `/profile?lang=zh/en` | 中英双语页面可加载，资料和订阅卡片一致 | 待测 |
| ⬜ | `/deliver-to/nl?lang=zh/en` | 中英双语库存页可加载，语言切换可用 | 待测 |
| ⬜ | `/deliver-to/fr?lang=zh/en` | 中英双语库存页可加载，语言切换可用 | 待测 |
